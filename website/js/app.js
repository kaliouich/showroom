...
const i18n = {
  ...
  fr: {
    ...
    freelance_offer_0_desc: "Le cluster que vous parcourez n'est pas un service managé. J'en ai architecturé et provisionné chaque couche moi-même sur Oracle Cloud : conception du VCN et des sous-réseaux, tables de routage, passerelles Internet et NAT, security lists et règles de pare-feu, dimensionnement des instances de calcul (ARM Ampere A1), volumes block et boot, enregistrements DNS et terminaison TLS. Kubernetes n'est venu qu'ensuite — par-dessus un réseau que j'avais dessiné d'abord.",
    freelance_offer_0_chips: '<span class="hire-chip">Conception VCN / VPC</span><span class="hire-chip">Sous-réseaux &amp; routage</span><span class="hire-chip">Passerelles NAT &amp; Internet</span><span class="hire-chip">Security Lists / NSG</span><span class="hire-chip">Provisionnement compute</span><span class="hire-chip">Volumes Block &amp; Boot</span><span class="hire-chip">DNS &amp; TLS</span><span class="hire-chip">Répartition de charge</span>',
