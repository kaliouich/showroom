...
const i18n = {
  en: {
    ...
    poison_status_working: 'Calling down a meteor…', poison_status_done: '{count} creature(s) poisoned ☄️ — watch for the revival in a few minutes',
  ...
  fr: {
    ...
    poison_status_working: "Appel d'une météorite…", poison_status_done: '{count} créature(s) empoisonnée(s) ☄️ — surveille la résurrection dans quelques minutes',
