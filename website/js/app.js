...
const i18n = {
  en: {
    ...
    about_rd_title: 'Firmware & Embedded Systems Engineer',
    ...
    nav_diy: '🛠️ DIY Guide',
    diy_hero_badge: 'Do It Yourself',
    diy_hero_title: 'Build This <span class="gradient-text">Infrastructure</span>',
    diy_hero_desc: 'A step-by-step technical guide with the exact commands needed to replicate this entire DevOps ecosystem on an Oracle Cloud Always Free instance.',
    diy_step1_title: '1. Provision Oracle Cloud VM',
    diy_step1_desc: 'Create an ARM Ampere A1 instance (4 OCPUs, 24GB RAM) on Oracle Cloud Always Free tier using Ubuntu 24.04.',
    diy_step2_title: '2. Configure Firewall (iptables)',
    diy_step2_desc: 'Oracle Cloud Ubuntu images come with strict <code>iptables</code> rules. We need to explicitly open HTTP (80) and HTTPS (443) ports.',
    diy_step3_title: '3. Install K3s (Lightweight Kubernetes)',
    diy_step3_desc: 'Deploy a single-node Kubernetes cluster without the default Traefik ingress controller to keep it clean. This command installs the K3s server.',
    diy_step4_title: '4. Install ArgoCD (GitOps)',
    diy_step4_desc: 'Install ArgoCD into the cluster to manage its state declaratively from a Git repository.',
    diy_step5_title: '5. Port-Forward ArgoCD UI',
    diy_step5_desc: 'Retrieve the initial admin password generated by ArgoCD and port-forward the server to access the UI locally.',
    diy_step6_title: '6. Bootstrap "App of Apps"',
    diy_step6_desc: 'Apply your root ArgoCD Application that points to your Git repository containing the rest of the cluster configuration (Prometheus, Demo App, etc.).'
  },
  fr: {
    ...
    about_rd_title: 'Ingénieur Firmware & Systèmes Embarqués',
    about_rd_desc: 'Programmation et débogage niveau matériel pour systèmes ARM Cortex/Linux dans des entreprises comme NXP, Hill-Rom, Ekinops et Itron. Pionnier des premières architectures Edge avec des passerelles Zigbee/WSN.',
    about_skills_title: 'Stack Technique',
    nav_diy: '🛠️ Guide DIY',
    diy_hero_badge: 'Faites-le vous-même',
    diy_hero_title: 'Construisez Cette <span class="gradient-text">Infrastructure</span>',
    diy_hero_desc: 'Un guide technique étape par étape avec les commandes exactes nécessaires pour reproduire tout cet écosystème DevOps sur une instance Oracle Cloud Always Free.',
    diy_step1_title: '1. Provisionner la VM Oracle Cloud',
    diy_step1_desc: 'Créez une instance ARM Ampere A1 (4 OCPU, 24 Go de RAM) sur le niveau gratuit d\'Oracle Cloud en utilisant Ubuntu 24.04.',
    diy_step2_title: '2. Configurer le Pare-feu (iptables)',
    diy_step2_desc: 'Les images Ubuntu d\'Oracle Cloud sont fournies avec des règles <code>iptables</code> strictes. Nous devons ouvrir explicitement les ports HTTP (80) et HTTPS (443).',
    diy_step3_title: '3. Installer K3s (Kubernetes Léger)',
    diy_step3_desc: 'Déployez un cluster Kubernetes à un seul nœud sans le contrôleur Ingress Traefik par défaut pour le garder propre. Cette commande installe le serveur K3s.',
    diy_step4_title: '4. Installer ArgoCD (GitOps)',
    diy_step4_desc: 'Installez ArgoCD dans le cluster pour gérer son état de manière déclarative à partir d\'un dépôt Git.',
    diy_step5_title: '5. Port-Forward de l\'UI ArgoCD',
    diy_step5_desc: 'Récupérez le mot de passe admin initial généré par ArgoCD et transférez le port du serveur pour accéder à l\'interface utilisateur localement.',
    diy_step6_title: '6. Démarrer "App of Apps"',
    diy_step6_desc: 'Appliquez votre Application ArgoCD racine qui pointe vers votre dépôt Git contenant le reste de la configuration du cluster (Prometheus, App Démo, etc.).'
  }
};
