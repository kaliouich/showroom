...
const i18n = {
  en: {
    ...
    heal_s4: "The API updates the gauge, Prometheus scrapes it, the alert resolves on its own. Measured end to end, no human involved: <strong>91 seconds</strong> for a fresh incident, near-instant when a death lands while the alert group is already active.",
  ...
  fr: {
    ...
    heal_s4: "L'API met à jour la jauge, Prometheus la collecte, l'alerte se résout seule. Mesuré de bout en bout, sans intervention humaine : <strong>91 secondes</strong> pour un incident frais, quasi instantané quand une mort survient pendant que le groupe d'alerte est déjà actif.",
