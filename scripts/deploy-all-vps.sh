...
echo "   🌐 Showcase:    http://showcase.${VM_IP}.nip.io"
echo "   🐣 Tamagotchi:  http://demo.${VM_IP}.nip.io"
echo "   🔄 ArgoCD:      https://argocd.${VM_IP}.nip.io  (guest / <YOUR_GUEST_PASSWORD>)"
echo "   📈 Grafana:     http://grafana.${VM_IP}.nip.io   (admin / <YOUR_ADMIN_PASSWORD>)"
echo "   🐙 Gitea:       http://git.${VM_IP}.nip.io       (khalil / <YOUR_ADMIN_PASSWORD>)"
echo "   📊 SonarQube:   http://sonar.${VM_IP}.nip.io     (admin / <YOUR_ADMIN_PASSWORD>)"
echo "=================================================================="
